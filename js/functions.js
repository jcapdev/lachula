...
jQuery($=> {
    ...
    $("#EU , #IT, #ES , #CH, #FR").on('click', function () {
        
        if(this.id=="EU"){
            $("#camioneta").fadeOut();
            setTimeout(function(){
                $("#camioneta").css("top","29%");
                $("#camioneta").css("left","20%");
                $("#camioneta").css("width","10%");
            }, 500);
            $("#camioneta").fadeIn(1800);
        }
        else if(this.id=="IT"){
            $("#camioneta").fadeOut();
            setTimeout(function(){
            $("#camioneta").css("top","30%");
            $("#camioneta").css("left","47%");
            $("#camioneta").css("width","7%");
            }, 500);
            $("#camioneta").fadeIn(1800);
        }
        else if(this.id=="CH"){
            $("#camioneta").fadeOut();
            setTimeout(function(){
            $("#camioneta").css("top","33%");
            $("#camioneta").css("left","70%");
            $("#camioneta").css("width","10%");
            }, 500);
            $("#camioneta").fadeIn(1800);
        }
            ...
            $("#camioneta").fadeOut();
            setTimeout(function(){
            $("#camioneta").css("top","32%");
            $("#camioneta").css("left","41%");
            $("#camioneta").css("width","7%");
            }, 500);
            $("#camioneta").fadeIn(1800);
        }
            ...
            $("#camioneta").fadeOut();
            setTimeout(function(){
            $("#camioneta").css("top","26%");
            $("#camioneta").css("left","45%");
            $("#camioneta").css("width","7%");
        }, 500);
            $("#camioneta").fadeIn(1800);
        }
    ...
    $("#tradicional , #tradicionalmob").on('click', function () {
        $('#modal1').modal('show');
    });
    $("#verde , #verdemob").on('click', function () {
        $('#modal2').modal('show');
    });
    $("#chipotle , #chipotlemob").on('click', function () {
        $('#modal3').modal('show');
    });
    ...
    $("#submit_btn1 , #submit_btn").on('click', function () {
        ...
        let userSubject = $('#subject1').val();
        let userPhone = $('#phone1').val();
        let userCompany = $('#client1').val();
        ...
        if (proceed) {
            ...
            //console.log(lan);
            if(lan=='es'){
                output = '<div class="alert-danger" style="padding:10px; margin-bottom:25px;">Por favor ingrese los campos requeridos.</div>';
            }
            if(lan=='en'){
                output = '<div class="alert-danger" style="padding:10px; margin-bottom:25px;">Please enter the required fields.</div>';
            }
    ...
    $("#partners-slider").owlCarousel({
        ...
        center: true,
        nav: true,
        navText: ["","<img src='images/arrowslide.png' style='width: 100%;'>"],
        responsive: {
            1200: {
                items: 1,
            },
    ...
    $("#price-slider").owlCarousel({
        ...
        dots: false,
        nav: true,
        navText: ["<img src='images/arrowslideleft.png' style='width: 100%;'>","<img src='images/arrowslide.png' style='width: 100%;'>"],
        loop: true,
        center: true,
        responsive: {
            1280: {
